...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=lailton_b%40hotmail.com).

"This exercise has an objective far bigger than React, it comes to explain the difference between imperative and declarative languages, for that JavaScript Vanilla and React are used. As JavaScript can actually be both imperative and declarative, React brings declarative solutions to many of the problems that JavaScript does imperatively."