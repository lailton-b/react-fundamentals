...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=01%3A%20Basic%20JavaScript-rendered%20Hello%20World&em=lailton_b%40hotmail.com).

"The first exercise made me think back on how applications are build with modern frameworks and what exactly is the problem that they came to solve.

Since I've been too much into writing code on React I have forgotten how it feels like to manipulate the DOM yourself. So it was a remind of how to access the document object, create elements, append elements and set attributes to them using pure JavaScript. All this dirty work is made by frameworks and we don't even realize."
