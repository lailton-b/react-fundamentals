...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=lailton_b%40hotmail.com).

"This exercise explains how morden React applications are written.
Not using only React, but also JSX and Babel to compile the JSX.
Going deep in the class and reading the documentation brings realizations
on how everything is made and why is made this way. It's not just about efficiency,
there is security reasons and a lot more."